...
export default function FilePanel() {
  ...
  const handleOpenFolder = useCallback(async () => {
    try {
      ...
      // Server-backed mode stores 'server' as a sentinel string. Only forward
      // arcwriteHandle to startIn if it's a real FileSystemDirectoryHandle.
      const startIn = (arcwriteHandle && arcwriteHandle.kind === 'directory') ? arcwriteHandle : 'documents';
