...
export default function AppShell() {
  ...
  const hideNav = isEditRoute && focusMode;
  ...
  const linkClass = ({ isActive }) =>
    `px-4 py-2 rounded font-semibold text-sm transition-colors ${isActive
  ...
  return (
    <SettingsContext.Provider value={openSettings}>
      ...
      >
        {/* F-001: Skip navigation for keyboard/screen reader users */}
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-[100] focus:bg-purple-600 focus:text-white focus:px-4 focus:py-2 focus:rounded focus:outline-none"
        >
            ...
            <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
              ...
              <div className="flex gap-2 items-center">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded font-semibold text-sm transition-colors border border-purple-500/30 ${isInitialized
