...
function Tab({ id, label, active, onClick }) {
  return (
    <button
      onClick={() => onClick(id)}
      className={`px-4 py-2 text-sm font-semibold rounded-t transition-colors ${active
      ...
      <Section title="Workflows">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-slate-800/50 rounded p-4 border border-purple-500/20">
            ...
            <p>
              Build a new story&rsquo;s dimensional arc from scratch or start from a genre template.
              Set dimension values at each story beat and watch your narrative take shape in real time.
              <strong>Series support</strong> lets you plan trilogies, sagas, and continuing series with
              macro arc structures and book position markers. <strong>Character arc editing</strong> maps
              dimension values per character across story positions.
            </p>
          </div>
          <div className="bg-slate-800/50 rounded p-4 border border-purple-500/20">
            ...
            <p>
              ...
              recommendations. <strong>Score progression</strong> tracks how your scores improve across
              analysis and revision runs.
            </p>
          </div>
          <div className="bg-slate-800/50 rounded p-4 border border-purple-500/20">
            ...
            <p>
              ...
              paragraph-by-paragraph. The <strong>Scenes tab</strong> maps scenes to scaffold beats with
              coverage tracking. Design <strong>named sequences</strong> &mdash; reusable prompt pipelines
              that chain steps together and write output to disk.
            </p>
          </div>
          <div className="bg-slate-800/50 rounded p-4 border border-purple-500/20">
            <h4 className="font-bold text-white mb-2">Dashboard</h4>
            <p>
              A unified project overview showing all scenes, chapters, and characters with
              <strong> beat mapping status</strong>, <strong>analysis scores</strong> with trend indicators,
              revision counts, and quick-action buttons to jump into Scaffold, Analyze, or Edit.
            </p>
          </div>
          <div className="bg-slate-800/50 rounded p-4 border border-purple-500/20">
...
flowchart TD
    A([Open Arcwright]) --> B{Provider\\nconfigured?}

    B -- No --> G["Settings ⚙ → Providers tab\\nAdd API key for OpenRouter,\\nAnthropic, OpenAI, or local"]
    G --> H
    B -- Yes --> H{What do you\\nwant to do?}
    ...
    <div className="flex flex-wrap gap-1 mb-5">
      {subs.map((s) => (
        <button
          ...
          className={`px-3 py-1 text-xs font-semibold rounded transition-colors ${active === s.id
      ...
      <div className="flex gap-1 mb-4">
        {subTabs.map((t) => (
          <button
            ...
            className={`px-3 py-1.5 text-xs font-semibold rounded transition-colors ${subTab === t.id
              ? 'bg-purple-500 text-white'
        ...
        <div className="space-y-6">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <span className="bg-emerald-600 text-white text-xs px-2 py-0.5 rounded font-mono">v3.1.0</span>
              <span className="text-purple-300 text-xs">2026-05-01</span>
            </div>
            <h4 className="font-bold text-white mb-2">Server-backed architecture, Series Wizard v2, ACP/MCP, HFE audit</h4>
            <div className="space-y-3">
              <div>
                <h5 className="font-semibold text-purple-300 text-xs uppercase tracking-wider mb-1">Architecture</h5>
                <ul className="list-disc list-inside text-xs text-purple-200 space-y-0.5">
                  <li>sql.js / WASM removed from the client &mdash; storage is now server-backed <code className="bg-slate-700/50 px-1 rounded">better-sqlite3</code> via the local Express API</li>
                  <li>Default data directory <code className="bg-slate-700/50 px-1 rounded">~/.arcwright/</code> (override with <code className="bg-slate-700/50 px-1 rounded">ARCWRIGHT_DATA</code>)</li>
                  <li>Two-process dev (Vite 5173 + Express 5174); single-process production via <code className="bg-slate-700/50 px-1 rounded">npm start</code></li>
                </ul>
              </div>
              <div>
                <h5 className="font-semibold text-purple-300 text-xs uppercase tracking-wider mb-1">Series &amp; ACP</h5>
                <ul className="list-disc list-inside text-xs text-purple-200 space-y-0.5">
                  <li>Series Wizard v2 + Series Manager v3 with server-backed series file API</li>
                  <li>ACP integration: standalone MCP server (<code className="bg-slate-700/50 px-1 rounded">mcp/arcwright-mcp-server.js</code>) for external agents, MCP presets UI in Settings</li>
                </ul>
              </div>
              <div>
                <h5 className="font-semibold text-purple-300 text-xs uppercase tracking-wider mb-1">HFE audit features</h5>
                <ul className="list-disc list-inside text-xs text-purple-200 space-y-0.5">
                  <li>F-009 Undo / Redo notifications</li>
                  <li>F-010 Promise-based confirm dialog (replaces <code className="bg-slate-700/50 px-1 rounded">window.confirm</code>)</li>
                  <li>F-012 Remappable keyboard shortcuts</li>
                </ul>
              </div>
              <div>
                <h5 className="font-semibold text-purple-300 text-xs uppercase tracking-wider mb-1">Other</h5>
                <ul className="list-disc list-inside text-xs text-purple-200 space-y-0.5">
                  <li>Local provider support: Ollama, LM Studio, Jan.ai, LocalAI</li>
                  <li>Plain (no-instructions) chat mode; Hook &amp; Premise button switches into it</li>
                  <li>Trial-expiration build gate removed</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <h4 className="font-bold text-white mb-2">Pillar Integration &mdash; Database, Series, Characters, Feedback &amp; Dashboard</h4>
            <div className="space-y-3">
              <div>
              ...
              <div>
                <h5 className="font-semibold text-purple-300 text-xs uppercase tracking-wider mb-1">Series Support</h5>
                <ul className="list-disc list-inside text-xs text-purple-200 space-y-0.5">
                  <li>4 series-level arc structures: Trilogy (3-book), Saga (5&ndash;7 book), Continuing (open-ended), Common World (shared world)</li>
                  <li>Series Arc Editor with visual timeline showing book position markers and series beats</li>
                  <li>Tri-state view mode in Scaffold: Book Arc | Series Arc | Overlay</li>
                  <li>Book position context displayed throughout the scaffold workflow</li>
                </ul>
              </div>
              <div>
                <h5 className="font-semibold text-purple-300 text-xs uppercase tracking-wider mb-1">Character Arc Editor</h5>
                <ul className="list-disc list-inside text-xs text-purple-200 space-y-0.5">
                  <li>Per-character, per-dimension arc point editing with value sliders (0&ndash;10) and story position (0&ndash;100%)</li>
                  <li>Character tabs with role labels (protagonist, antagonist, love interest, supporting)</li>
                  <li>Beat reference markers show scaffold beats alongside character arc points</li>
                  <li>All arc data persisted to SQLite</li>
                </ul>
              </div>
              <div>
                <h5 className="font-semibold text-purple-300 text-xs uppercase tracking-wider mb-1">Scene-to-Beat Mapping</h5>
                <ul className="list-disc list-inside text-xs text-purple-200 space-y-0.5">
                  <li>New Scenes tab in the editor&rsquo;s left panel for managing scene-to-beat assignments</li>
                  <li>Scenes grouped by chapter with beat assignment dropdowns and coverage tracking</li>
                  <li>Quick-add scene form with beat and chapter linking</li>
                  <li>Expanded template variables: <code className="text-purple-200 bg-slate-700/50 px-1 rounded">{'{{beat_name}}'}</code>, <code className="text-purple-200 bg-slate-700/50 px-1 rounded">{'{{scene_title}}'}</code>, <code className="text-purple-200 bg-slate-700/50 px-1 rounded">{'{{expected_dimensions}}'}</code>, <code className="text-purple-200 bg-slate-700/50 px-1 rounded">{'{{pov_character}}'}</code>, <code className="text-purple-200 bg-slate-700/50 px-1 rounded">{'{{beat_guidance}}'}</code></li>
                </ul>
              </div>
              <div>
                <h5 className="font-semibold text-purple-300 text-xs uppercase tracking-wider mb-1">Analysis Feedback Loop</h5>
                <ul className="list-disc list-inside text-xs text-purple-200 space-y-0.5">
                  <li>Revision pipeline automatically records analysis snapshots to scene score history after each revision</li>
                  <li>Score Progression Panel in Analysis: before/after dimension comparison table with delta and trend indicators</li>
                  <li>Snapshot timeline showing revision vs analysis runs (&uarr; improving, &darr; declining, &rarr; stable)</li>
                  <li>Re-analyze action for individual scenes</li>
                </ul>
              </div>
              <div>
                <h5 className="font-semibold text-purple-300 text-xs uppercase tracking-wider mb-1">Project Dashboard</h5>
                <ul className="list-disc list-inside text-xs text-purple-200 space-y-0.5">
                  <li>Unified project overview at <code className="text-purple-200 bg-slate-700/50 px-1 rounded">/dashboard</code> with book metadata and series context</li>
                  <li>Stat cards: chapters, scenes, characters, settings, beat coverage %, analysis count</li>
                  <li>Scene grid with mini dimension score bars and status badges (mapped, analyzed, revised)</li>
                  <li>Beat mapping status grid showing scaffold beats with linked scene counts</li>
                  <li>Quick-nav links to Scaffold, Analyze, and Edit workflows</li>
                </ul>
              </div>
            </div>
          </div>
