 ...
 */
export async function createSeriesFolder(_arcwriteHandle, seriesName) {
  await apiPost('/projects/series', { name: seriesName });
}

/**
 * List series folders in projects/series/.
 */
export async function listSeriesFolders(_arcwriteHandle) {
  try {
    return await apiGet('/projects/series');
  } catch {
    return [];
  }
}
